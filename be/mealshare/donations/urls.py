...
from .views import DonationListCreateView, DonationDetailView, DonationStatusUpdateView, DonationRequestListCreateView, DonationRequestDetailView, DonationRequestReserveView, DonationRequestClaimView, DonationMyPickupsView
